    ...
    if (!isSetup) {
        ...
        server.register(
            [
                ...
                },
                {
                    ...
                    options: {
                        fontSrc: ['self', 'oss.maxcdn.com', 'netdna.bootstrapcdn.com', 'data:'],
                        styleSrc: ['self', 'oss.maxcdn.com', 'netdna.bootstrapcdn.com']
                    }
                },
                {
        ...
        if (argv !== 'test') {
            server.register(
                [
                    {
                        register: require('../modules/code-project/plugin')
                    }
                ],
                (err) => {
                    if (err) {
